...
public interface LiveProtocol {
  ...
  /**
   * Detailed token count information for a specific modality.
   *
   * @param modality The modality (e.g., "TEXT").
  ...
  /**
   * Metadata pertaining to the API usage.
   *
   * @param promptTokenCount
   * @param responseTokenCount
   * @param totalTokenCount
   * @param promptTokensDetails
   * @param responseTokensDetails
   */
  record UsageMetadata(
    Optional<Integer> promptTokenCount,
    Optional<Integer> responseTokenCount,
    Optional<Integer> totalTokenCount,
    Optional<List<TokenDetails>> promptTokensDetails,
    Optional<List<TokenDetails>> responseTokensDetails
  ) {}
   ...
   * @param usageMetadata Metadata about the API usage for the response
   */
